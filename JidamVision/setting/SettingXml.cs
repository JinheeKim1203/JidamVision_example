...
namespace JidamVision.setting
{
    ...
    환경설정 정보를 XML방식으로 저장하고, Singleton 방식으로 어디서나 호출하여 사용
    환경설정 파일은 실행파일 폴더 안에 Setup/Setting.xml로 저장
...
*/
    ...
    internal class SettingXml
    {
        ...
        public static void Save()
        {
            ...
            XmlHelper.SaveXml(settingFilePath, Inst);  // 자기 자신이라서 Inst만 써도 된다
        }
        ...
        { 
            ...
            setting.ModelDir = @"d:\model";  //경로에 대한 Default값을 주는 것
            return setting;
        }
